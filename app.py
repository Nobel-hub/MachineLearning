...
def fetch_poster(movie_id):
    response = requests.get('https://api.themoviedb.org/3/movie/{}?api_key=a431aae82d0cc519a197ee4061e0fde2'.format(movie_id))
    data = response.json()
...
selected_movie_name = st.selectbox('Select the movie you would like to watch', movies['title'].values)
